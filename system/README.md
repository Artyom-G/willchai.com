...
wait for active scrolling to settle. Larger phone cards follow a closer diagonal
path. The character fades before the following photograph reaches its area. The
four second greeting uses the approved four poses and integer enlargement. The later
